...
public class Conjugaison extends AppCompatActivity implements verbesAdapter.verbesAdapterListener{
    ...
    private verbesAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new verbesAdapter(this, verbesList, this);
        ...
        JsonArrayRequest request = new JsonArrayRequest(URL,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        List<verbes> items = new Gson().fromJson(response.toString(), new TypeToken<List<verbes>>() {
                        }.getType());

                        // adding contacts to contacts list
                        verbesList.clear();
                        verbesList.addAll(items);
